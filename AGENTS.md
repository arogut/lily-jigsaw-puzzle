...
- Add instructions to `AGENTS.md`, skills to `.agents/skills/<name>/SKILL.md`, MCP servers to
  `.mcp.json`.
- Tool-specific config (e.g. `.claude/settings.json` permissions) stays in the vendor directory.

See `agent-agnostic-plan.md` for the full rationale and extension conventions.
