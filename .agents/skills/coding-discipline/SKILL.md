...
description: Planning, scope control, and execution discipline before and during implementation. Use when starting a task, when requirements are unclear, when tempted to refactor adjacent code, or when defining success criteria.
---
